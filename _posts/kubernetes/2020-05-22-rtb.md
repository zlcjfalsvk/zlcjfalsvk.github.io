...
1. docker-compose.yml을 어떻게 k8s로 배포하나? 
   ...
   ![convert](../../assets/img/_posts/kubernetes/rtb/customResource.png)
...
2. resource file 적용하기
   ...
   ![apply](../../assets/img/_posts/kubernetes/rtb/apply.png)
...
1. minikube dashboard를 이용하면 로그 및 파드 콘솔에 접속할 수 있다.
      ...
      ![info](../../assets/img/_posts/kubernetes/rtb/info.png)
...
2. mysql
   ...
   ![해결](../../assets/img/_posts/kubernetes/composeTokube/mysql.png)