...
## 페이스북 개발자 센터에서 새앱 추가
  ...
  ![1](/assets/img/posts/facebook_login/create/1.png)


## 테스트앱 만들기 (테스트앱을 만들면 로컬에서도 페이스북 로그인이 가능하다)

  ![2](/assets/img/posts/facebook_login/create/2.png)

## 만들어진 화면 -제품추가의 Facebook로그인 설정

  ![3](/assets/img/posts/facebook_login/create/3.png)
...
설정으로 직접 설정
  ...
  ![4](/assets/img/posts/facebook_login/create/4.png)

## localhost를 기입하면 오류가 나지만 테스트 앱은 가능하다.

  ![5](/assets/img/posts/facebook_login/create/5.png)

## 기본 세팅 완료

  ![6](/assets/img/posts/facebook_login/create/6.png)
...
1. 기본설정 - 앱 id & 시크릿 코드 및 기본설정을 세팅
  ...
  ![7](/assets/img/posts/facebook_login/create/7.png)

2. 고급설정 - API버전 및 제한등을 설정하는곳

  ![8](/assets/img/posts/facebook_login/create/8.png)
